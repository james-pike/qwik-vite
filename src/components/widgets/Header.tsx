...
export default component$(() => {
  ...
  return (
    <header
      id="header"
      class={`sticky top-0 z-40 flex-none mx-auto w-full border-t-4 border-t-blue-900 border-b-blue-900 border-b-4 border-gray-50/0 transition-[opacity] ease-in-out ${
        store.isScrolling
